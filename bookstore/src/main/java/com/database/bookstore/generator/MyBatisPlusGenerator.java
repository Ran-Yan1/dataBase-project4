package com.database.bookstore.generator;
...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("RanYan&&ChenPan");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/bookstore?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.database.bookstore");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
